...
function GameOver($end,$win){
	...
	$xml->ending=$end;
	$xml->winner=$win;
	$query3="INSERT INTO gamelogset (StartTime,OverTime,Winner,Ending,Amount,LoopTurn,Content,Chapter) VALUES ($xml->starttime,$xml->overtime,$xml->winner,$xml->ending,$xml->palyeramount,$xml->loop,$xml->content,$xml->chapter)";
