	...
	while($xmlItm->Item[$i]->Name!=null)
		{
			...
			$V2=$xmlItm->Item[$i]->Lucky;
			$result=mysql_query("INSERT INTO itemset (id,Type,Effect,Durable,Name,Location,SkillId,Description,Lucky) VALUES ('$ID2','$T2','$E2','$D2','$N2','$L2','$S2','$De2','$V2')"); 
			$i++;
		}
	...
	while($xmlLoc->Location[$i]->Name!=null)
		{
			...
			$NE3=$xmlLoc->Location[$i]->Neighbour;
			$result=mysql_query("INSERT INTO locationset (id,Name,Attribution,Building,Neighbour) VALUES ('$ID3','$N3','$A3','$B3','$NE3')"); 
			$i++;
		}
	...
	while($xmlNpc->Npc[$i]->Name!=null)
		{
			...
			$DI4=$xmlNpc->Npc[$i]->Discover;
			$COV4=$xmlNpc->Npc[$i]->Cover;
			$result=mysql_query("INSERT INTO roleset (id,Name,Exp,Level,Strength,Agility,Endurance,Magic,TrumpAbility,Lucky,Money,Status,Kills,Attitude,Contribution,Attack,Defense,Hit,Miss,Move,Health,MagicAttack,MagicDefense,MaxHealth,LastWord,KillWord,TitleId,ArmorId,HelmetId,ShoeId,TrumpId,TransportId,AccessoriesId,WeaponId,LocationId,Discover,Cover) VALUES ('$ID4','$NA4','$EX4','$LE4','$ST4','$AG4','$EN4','$MA4','$TRAB4','$LU4','$MO4','$STA4','$KI4','$AT4','$CO4','$ATT4','$DE4','$HI4','$MI4','$MOV4','$HEA4','$MAA4','$MAD4','$MH4','$LW4','$KW4','$TI4','$AR4','$HE4','$SH4','$TR4','$TRA4','$ACC4','$WE4','$LO4','$DI4','COV4')"); 
			$i++;
		}
